...
const ROOMS: RoomSeed[] = [
  ...
  { code: 'AILAB -1D 16-MAC',  name: 'Data', roomType: 'pod', district: 'AI Lab', neighborhood: '-1D', capacity: 1,  theme: 'code',   equipment: 'Mac Studio',         specs: deviceSpecs(MAC_BASE, 1), description: 'Mac Studio iş istasyonu — bireysel geliştirme pod’u.' },
  { code: 'AILAB -1D 17-MAC',  name: 'Analytics',         roomType: 'pod', district: 'AI Lab', neighborhood: '-1D', capacity: 1,  theme: 'code',   equipment: 'Mac Studio',         specs: deviceSpecs(MAC_BASE, 1), description: 'Mac Studio iş istasyonu — bireysel geliştirme pod’u.' },
